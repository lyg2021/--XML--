...
def change_to_geogcs(Coordinates_Text:str):
    ...
    transformer = Transformer.from_crs(crs_from=32645, crs_to=crs)
    ...
    for index, point in enumerate(float_number_list):
        if index%2 == 0:
            ...
            tem_y = point
            float_number_list[index], float_number_list[index-1] = transformer.transform(xx=tem_x, yy=tem_y)
...
def main(input_path:str, output_path:str, GEOGCS_CoordSysStr_Text:str, PROJ_CoordSysStr_Text:str):
    ...
    for Region in tqdm(Region_Element_list):
        ...
        for GeometryDef in tqdm(GeometryDef_Element_list):
            ...
            if CoordSysStr_Text == PROJ_CoordSysStr_Text:
                    ...
                    for Exterior in Exterior_Element_list:
                        ...
                        for LinearRing in LinearRing_Element_list:
                            ...
                            for Coordinates in Coordinates_Element_list:
                                ...
                                Coordinates.text = change_to_geogcs(Coordinates_Text=Coordinates_Text)                                    
                
                CoordSysStr.text = GEOGCS_CoordSysStr_Text                            
...
if __name__ == "__main__":
    main(input_path="shawan_6_fenlei.xml", 
         output_path="shawan_6_fenlei_GEOGCS.xml", 
